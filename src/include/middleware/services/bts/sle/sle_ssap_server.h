 ...
 */
typedef enum {
    SLE_INDICATION_CFM_FAIL           = 0x00,    /*!< @if Eng Indication cfm fail
                                                      @else   指示接收失败 @endif */
    SLE_INDICATION_CFM_SUCESS         = 0x01,    /*!< @if Eng Indication cfm sucess
                                                      @else   指示接收成功 @endif */
 ...
 * @endif
 */
typedef void (*ssaps_indicate_cfm_callback)(uint8_t server_id, uint16_t conn_id,
