...
struct bt_mesh_health_cli {
    ...
    void (*current_status)(struct bt_mesh_health_cli *cli, uint16_t addr, uint8_t test_id, uint16_t cid,
...
#define BT_MESH_MODEL_HEALTH_CLI(cli_data, pub) \
    BT_MESH_MODEL_CB(BT_MESH_MODEL_ID_HEALTH_CLI, bt_mesh_health_cli_op, pub, cli_data, &bt_mesh_health_cli_cb)


int bt_mesh_health_fault_get(uint16_t addr, uint16_t app_idx, uint16_t cid, uint8_t *test_id, uint8_t *faults,
    size_t *fault_count);

int bt_mesh_health_fault_clear(uint16_t addr, uint16_t app_idx, uint16_t cid, uint8_t *test_id, uint8_t *faults,
    size_t *fault_count);

int bt_mesh_health_fault_test(uint16_t addr, uint16_t app_idx, uint16_t cid, uint8_t test_id, uint8_t *faults,
    size_t *fault_count);
...
struct bt_mesh_model *bt_mesh_get_health_cli_model(void);
