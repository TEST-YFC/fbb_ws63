...
OAL_STATIC osal_u32 g_low_pk_mode_th = LOW_PK_MODE_TH;
OAL_STATIC osal_u32 g_high_pk_mode_th = HIGH_PK_MODE_TH;
...
/*****************************************************************************
  3 函数实现
*****************************************************************************/
#if defined(_PRE_WLAN_FEATURE_NEGTIVE_DET) && defined(_PRE_WLAN_FEATURE_STAT)
