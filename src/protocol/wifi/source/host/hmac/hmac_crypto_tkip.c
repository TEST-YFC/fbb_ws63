    ...
    osal_u8 hdr[16])
{
    ...
    switch (frame_dir) {
        case IEEE80211_FC1_DIR_NODS:
            (void)memcpy_s(hdr, WLAN_MAC_ADDR_LEN, frame_4addr_hdr->address1, WLAN_MAC_ADDR_LEN);
            (void)memcpy_s(hdr + WLAN_MAC_ADDR_LEN, WLAN_MAC_ADDR_LEN,
                frame_4addr_hdr->address2, WLAN_MAC_ADDR_LEN);
            break;
        case IEEE80211_FC1_DIR_TODS:
            (void)memcpy_s(hdr, WLAN_MAC_ADDR_LEN, frame_4addr_hdr->address3, WLAN_MAC_ADDR_LEN);
            (void)memcpy_s(hdr + WLAN_MAC_ADDR_LEN, WLAN_MAC_ADDR_LEN,
                frame_4addr_hdr->address2, WLAN_MAC_ADDR_LEN);
            break;
        case IEEE80211_FC1_DIR_FROMDS:
            (void)memcpy_s(hdr, WLAN_MAC_ADDR_LEN, frame_4addr_hdr->address1, WLAN_MAC_ADDR_LEN);
            (void)memcpy_s(hdr + WLAN_MAC_ADDR_LEN, WLAN_MAC_ADDR_LEN,
                frame_4addr_hdr->address3, WLAN_MAC_ADDR_LEN);
            break;
        default:
            (void)memcpy_s(hdr, WLAN_MAC_ADDR_LEN, frame_4addr_hdr->address3, WLAN_MAC_ADDR_LEN);
            (void)memcpy_s(hdr + WLAN_MAC_ADDR_LEN, WLAN_MAC_ADDR_LEN,
                frame_4addr_hdr->address4, WLAN_MAC_ADDR_LEN);
            break;
    }
