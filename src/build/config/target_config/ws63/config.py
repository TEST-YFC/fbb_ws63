...
target = {
    ...
    'ws63-flashboot': {
        ...
        'ram_component': [
            ...
            'efuse', 'hal_efuse_v151', 'efuse_port', 'soc_port','-:drv_timer',
        ],
    ...
    'ws63-loaderboot': {
        ...
        'ram_component': [
            ...
            "error_code", "board_config", "chip_boot_port", "chip_boot_config",
             '-:hal_systick','efuse_port', 'hal_efuse_v151', 'efuse','-:drv_timer',
        ],
    ...
    'ws63-liteos-spi-host': {
        ...
        'defines': [
            ...
            "CONFIG_SUPPORT_SLE_BASE_STATION",
            "CONFIG_SLE_BASE_STATION_MASTER",
        ],
        'ram_component': [
            'ws63_liteos_app',
            'ws63_liteos_app_lds',
            ...
            "coap",
            "sle_netdev","chba_at",
            "hcc_host", 'syschannel_host',
        ],
        'ccflags': [
            "-DBOARD_ASIC", '-DPRE_ASIC',
        ],
        'application': 'application',
        'bin_name': 'ws63-liteos-spi-host',
        'smaller': True,
        'hso_enable_bt': True,
        'hso_enable': True,
        'codesize_statistic': True,
    ...
    'ws63-liteos-spi-device': {
        ...
        'application': 'application',
        'bin_name': 'ws63-liteos-spi-device',
        'smaller': True,
        'hso_enable_bt': True,
        'hso_enable': True,
        'codesize_statistic': True,
    ...
    'ws63-liteos-app-mesh': {
        ...
        'defines': [
            ...
            'CONFIG_UART_SUPPORT_LPM',
            "TARGET_CHIP_WS63=1",
            "CONFIG_SLE_MESH_DFX=1",
            "SLE_MESH_SUPPORT",
            "CONFIG_SLE_C_FRAME_SUPPORT",
            'CONFIG_SLE_PRIVATE_SET_ADV_DATA',
        ],
        'ram_component': [
            'ws63_liteos_app',
            'ws63_liteos_app_lds',
            ...
            "dfx_port_ws63", "algorithm", "cmn_header", "lwip", "lwip_tcm", "wifi_service", "mbedtls_v3.6.0", 'mbedtls_harden', "wpa_supplicant",
            "at", "wifi_driver_hmac", "wifi_driver_dmac", "wifi_driver_tcm", "wifi_at", "wifi_csa", "wifi_frag", "wifi_alg_txbf", "wifi_alg_temp_protect", "wifi_tx_amsdu",
            "wifi_auto_adjust_freq", "wifi_alg_anti_interference", "wifi_alg_edca_opt", "wifi_alg_cca_opt",
            'wifi_btcoex', "wifi_uapsd_ap", 'sio_port', 'i2s', 'hal_sio',
            'liteos_208_5_0',
            'nv', 'nv_ws63', 'nv_zdiag_ws63', 'plt_at', 'dfx_printer',
            'update_common', 'update_common_ws63', 'update_ab_ws63', 'factory_ws63', 'update_storage', 'update_storage_ws63',
        ...
        'application': 'application',
        'bin_name': 'ws63-liteos-app-mesh',
        'smaller': True,
        'hso_enable_bt': True,
        'hso_enable': True,
        'codesize_statistic': True,
        'nv_update':True,
        'generate_efuse_bin': False,
        'copy_files_to_interim': True,
        'close_wifi_ccpriv': True,
    },
}
