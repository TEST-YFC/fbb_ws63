...
class upg_base_info:
    def __init__(self):
        ...
        self.app_bin = os.path.join(self.output, "acore", "ws63-liteos-sle-mesh-one-touch-sample", "ws63-liteos-sle-mesh-one-touch-sample-sign.bin")
