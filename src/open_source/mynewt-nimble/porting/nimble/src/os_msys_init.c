...
{
#if MYNEWT_VAL(MSYS_1_BLOCK_COUNT) > 0
    BT_DBG("os_msys_deinit msys1 \r\n");
    os_mempool_deinit(&os_msys_1_mempool);
    memset_s(&os_msys_1_mbuf_pool, sizeof(os_msys_1_mbuf_pool), 0, sizeof(os_msys_1_mbuf_pool));
    memset_s(os_msys_1_data, MYNEWT_VAL(MSYS_1_BLOCK_COUNT) * SYSINIT_MSYS_1_MEMBLOCK_SIZE, 0,
           MYNEWT_VAL(MSYS_1_BLOCK_COUNT) * SYSINIT_MSYS_1_MEMBLOCK_SIZE);

#endif

#if MYNEWT_VAL(MSYS_2_BLOCK_COUNT) > 0
    BT_DBG("os_msys_deinit msys2 \r\n");
    os_mempool_deinit(&os_msys_2_mempool);
    memset_s(&os_msys_2_mbuf_pool, sizeof(os_msys_2_mbuf_pool), 0, sizeof(os_msys_2_mbuf_pool));
    memset_s(os_msys_2_data, MYNEWT_VAL(MSYS_2_BLOCK_COUNT) * SYSINIT_MSYS_2_MEMBLOCK_SIZE, 0,
           MYNEWT_VAL(MSYS_2_BLOCK_COUNT) * SYSINIT_MSYS_2_MEMBLOCK_SIZE);
