...
#ifdef MYNEWT_VAL_BLE_EXT_ADV_MAX_SIZE
#define BT_MESH_ADV_DATA_SIZE MYNEWT_VAL_BLE_EXT_ADV_MAX_SIZE
#else
#define BT_MESH_ADV_DATA_SIZE 251
#endif

/* The user data is a pointer (4 bytes) to struct bt_mesh_adv */
#define BT_MESH_ADV_USER_DATA_SIZE 7
