...
// add for feature support ext seg sdu, MAX PDU(251) - NET Header(9) - MIC(8) - SEG Header(4)
#define BT_MESH_APP_SEG_EXT_SDU_MAX        230
...
#define BT_MESH_MODEL_ID_RMT_PROV_SRV              0x0004
#define BT_MESH_MODEL_ID_RMT_PROV_CLI              0x0005
 ...
 */
#define BT_MESH_TRANSMIT(count, int_ms) ((count>7?7:count) | (((int_ms / 10) - 1) << 3))
...
struct bt_mesh_model_cb {
	 ...
	 *
	 * Called when the mesh node is deinit. 
	 *
	 *  @note 
	 *  
	 * 
