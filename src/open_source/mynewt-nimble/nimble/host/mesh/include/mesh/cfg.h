...
/** @brief used to add an address to a Subscription List of a model.
 *
 *  @param mod Model this callback belongs to.
 *  @param sub_addr Subscription addr.
 *
 *  @return Zero on success or (negative) error code otherwise.
 */
int bt_mesh_add_mod_sub(struct bt_mesh_model *mod, uint16_t sub_addr);

/** @brief used to delete an address to a Subscription List of a model.
 *
 *  @param mod Model this callback belongs to.
 *  @param sub_addr Subscription addr.
 *
...
/** @brief used to overwrite an address to a Subscription List of a model.
 *
 *  @param mod Model this callback belongs to.
 *  @param sub_addr Subscription addr.
 *
